...
}`,...d.parameters?.docs?.source},description:{story:"커스텀 내용 모달(권한 팝업, Figma Bottom Sheet v1.0.0). openModal 옵션으로 스타일·닫기 버튼 제어.",...d.parameters?.docs?.description}}};const X=["Alert","Confirm","DestructiveConfirm","PermissionContent"];export{l as Alert,c as Confirm,m as DestructiveConfirm,d as PermissionContent,X as __namedExportsOrder,W as default};
