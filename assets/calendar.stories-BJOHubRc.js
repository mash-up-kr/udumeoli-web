import{j as n}from"./jsx-runtime-u17CrQMm.js";import{H as o}from"./iframe-D_xONYLO.js";import{C as a}from"./calendar-Cr9isBqe.js";import"./preload-helper-PPVm8Dsz.js";import"./utils-WKja2AN6.js";import"./createLucideIcon-DiRPc2ew.js";import"./chevron-right-PsXwYGzV.js";const D={component:a,parameters:{layout:"centered",docs:{description:{component:"react-day-picker 기반 날짜 선택 캘린더 (Figma Date Picker v1.0.0). 한국어·월요일 시작, 오늘/선택 상태 브랜드 컬러. 항상 6주 고정 렌더(fixedWeeks)로 달 이동 시 높이가 흔들리지 않는다."}}}},e={render:()=>{const[r,s]=o.useState();return n.jsx(a,{mode:"single",selected:r,onSelect:s})}},t={render:()=>{const[r,s]=o.useState(new Date(2026,6,9));return n.jsx(a,{mode:"single",month:new Date(2026,6,1),selected:r,onSelect:s})}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  render: () => {
