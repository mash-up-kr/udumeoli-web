import{j as e}from"./jsx-runtime-u17CrQMm.js";import{H as n}from"./header-B7RsMB7v.js";import{M as r}from"./mobile-layout-NqJ6JoMc.js";import"./utils-WKja2AN6.js";import"./x-Cj3_p01N.js";import"./createLucideIcon-D0qFFDxK.js";import"./iframe-Cf0KpDSd.js";import"./preload-helper-PPVm8Dsz.js";import"./arrow-left-DlRyix-F.js";const y={component:r,tags:["autodocs"],parameters:{layout:"fullscreen",docs:{description:{component:["모든 페이지를 감싸는 모바일 영역 컨테이너.","","- **기준 크기 375×812** (iPhone X). 이 크기에서 시안과 1:1로 보입니다.","- 더 작은 폰(360 등)은 자동으로 줄어듭니다. (min 없음)","- 더 큰 화면은 **최대 448px**(`max-w-md`)에서 멈추고 가운데 정렬됩니다.","- 좌우 여백(거터)은 브랜드 틴트 aurora 그라디언트 배경이 균등하게 남고, 프레임은 앰비언트 섀도로 떠 보입니다.","","👉 상단 툴바의 **Viewport**를 바꿔가며 기기별로 확인하세요."].join(`
