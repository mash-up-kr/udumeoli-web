...
export function DateSection({
  ...
  // 6명부터는 겹침을 키워 행 총폭이 패널 밖으로 삐져나가지 않게 (6×70 − 5×18 = 330px)
  const overlapCls = slots.length >= 6 ? "-mr-[18px]" : "-mr-3"
        ...
        {ordered.map((slot, i) => {
          ...
          return (
            <div
              key={slot.memberId}
              className={cn(
                "relative flex items-center justify-center p-[3px] last:mr-0",
                overlapCls,
