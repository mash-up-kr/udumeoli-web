...
/**
 * Figma TextInput 필드 (v1.0.0). rounded-full(알약), 상태별 border 토큰.
...
function Input({ className, type, ...props }: React.ComponentProps<"input">) {
  return (
    <input
      ...
      data-slot="input"
      className={cn(
        "w-full min-w-0 rounded-full border border-stroke-neutral-subtle bg-bg-neutral-weak px-4 py-3 text-b4 text-fg-neutral-bold transition-colors outline-none",
